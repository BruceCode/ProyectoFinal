...
class ApplicationMain {
	...
	public static function main () {
		...
		flash.Lib.setPackage ("HaxeFlixel", "arcadePF", "com.example.myapp", "0.0.1");
		...
		telemetryConfig.app_name = "arcadePF";
		#end
...
class ApplicationMain {
	...
	public static function main () {
		...
		wx.App.boot (function () {
			...
			frame = wx.Frame.create (null, null, "arcadePF", null, { width: 800, height: 600 });
