...
class Main extends Sprite 
{
	...
	{
		super();
		addChild(new FlxGame(800, 600, Intro));
...
/*
	...
	//valores forzados para leer que pasa y reproducirlos
	
	
	//var gameWidth:Int = 70*16; // Width of the game in pixels (might be less / more in actual pixels depending on your zoom).
	//var gameHeight:Int = 70*8; // Height of the game in pixels (might be less / more in actual pixels depending on your zoom).
	
	var initialState:Class<FlxState> = Intro; // The FlxState the game starts with.
	//var initialState:Class<FlxState> = PlayState; // The FlxState the game starts with.
	//var initialState:Class<FlxState> = Selector; // The FlxState the game starts with.
